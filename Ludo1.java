...
{
	JFrame f,f2;
	JLabel l[],m,image,dic,hero,rms,he;
	JLabel blue[],green[],red[],yellow[];
	JFrame f1=new JFrame("MENU");
	JFrame options=new JFrame("OPTIONS");
	JFrame hell=new JFrame("HELP");
	JRadioButton player1,player2,player3,player4;
	JTextField screen;
	...
	{
		f=new JFrame("Ludo");
		f2=new JFrame ("NO NUMBER PLAYER");
		l=new JLabel[89];
		o=new Listener(this);
		f1=new JFrame("MENU");
		/*
		...
		*/
		f.setContentPane(new JLabel(new ImageIcon("d.jpg")));//       .\\d.jpg
		Font font=new Font("TEMPUS SANS ITS",Font.BOLD,38);
		Font font1=new Font("TEMPUS SANS ITS",Font.BOLD,38);
		...
		exit.setIcon(new ImageIcon("exit.png"));   //exit.png
		exit.setBorder(null);
		...
		reset.setIcon(new ImageIcon("reset.png"));   //reset.png
		...
		mmenu.setIcon(new ImageIcon("home.png"));   //home.png
		...
		rms.setIcon(new ImageIcon(""));
		f.add(rms); 				//rms.jpg

		
		he=new JLabel();
		he.setBounds(120,120,638,479);
		he.setIcon(new ImageIcon("help.jpg"));		//help.jpg
		hell.add(he);
		
		dice=new JButton();
		dice.setBounds(20,620,100,50);
		dice.setIcon(new ImageIcon("roll.png"));	//roll.png
		dice.setBorder(null);
		...
		play.setIcon(new ImageIcon("play.png"));	//play.png
		play.setBorder(null);
		...
		option.setIcon(new ImageIcon("option.png"));	//option.png
		...
		help.setIcon(new ImageIcon("help.png"));	//help.png
		help.setBorder(null);
...
/**************Choice buttons for selecting goti***********/
		...
		choice[0].setIcon(new ImageIcon("super.png")); //super.png
		choice[1].setIcon(new ImageIcon("bat.png")); //bat.png		
		choice[2].setIcon(new ImageIcon("captain.png")); //captain.png
		choice[3].setIcon(new ImageIcon("spider.png")); //spider.png		

		m=new JLabel();
		m.setBounds(130,100,600,600);
		m.setIcon(new ImageIcon("ludo.jpg")); //ludo.jpg
		//m has not been added		

		dic=new JLabel();
		dic.setBounds(20,450,72,70);
		dic.setIcon(new ImageIcon("dice.jpg")); //dice.jpg
		f.add(dic);		
...
/***************************BOARD***************************/
	...
	/*******************these loops for red area***********************************/
		
		j=0;
		for(int i=10;i>=5;i--)
		{
			l[i].setBounds(130,417+j,39,39);
			j=j+39;
		}
		...
		for(int i=57;i<=61;i++)
		{
			l[i].setBounds(169,370+j,39,39);
			j=j+39;
		}
	/**************************** these loops are for green area**************/
		j=0;
		for(int i=18;i<=23;i++)
		{
	...
	/********************************extra pics**************************************/
		...
		f1.setContentPane(new JLabel(new ImageIcon("menu.png"))); //menu.png
		f1.add(play);
		f1.add(option);
		f1.add(help);
		f1.add(exit);
...
//******************************** checkbox ***********************************//
		...
		player2.setBounds(400,150,300,100);
		player3.setBounds(400,270,300,100);
		player4.setBounds(400,390,300,100);
		...
		okay=new JButton();
		okay.setFont(font1);
		okay.setIcon(new ImageIcon("ok.png")); //ok.png
		...
		f2.setContentPane(new JLabel(new ImageIcon("Navy-Blue-HD-Wallpaper.jpg"))); //option.jpg
		...
		options.setContentPane(new JLabel(new ImageIcon("option.png"))); //option.jpg
		...
		hell.setContentPane(new JLabel(new ImageIcon("menung.jpg"))); //menung.jpg
		hell.add(he);
...
class Listener implements ActionListener
{
	...
	void randomNumber()
	{
		...
		rno= generator.nextInt(6) +1;//random no storing to rno
		d.image.setIcon(new ImageIcon ("dice"+rno+".png"));///////////
	}
	
	//*********************new position ***************///////////
	/*BIGGGGGGGGGGGGGGGGGGGGG Commenttttttttttttttttttttttttttttttt*/
	...
	/*********** for cutting the player ******************/
	/*********** this function will check whether any position two different team members is at same place if so then cut method will apply acc. to rules of ludo */
